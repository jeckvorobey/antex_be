...
order-handoff-rich =
    ...
    <p>Менеджер готов продолжить обмен и согласовать детали.</p>
    <hr/>
    <h3>Что нужно сделать</h3>
    <ol>
      <li><b>Откройте чат.</b> Нажмите «Написать менеджеру».</li>
      <li><b>Отправьте сообщение.</b> Проверьте подготовленный текст и нажмите кнопку отправки.</li>
    </ol>
    <aside><b>Важно.</b> Текст появится в поле ввода, но не отправится автоматически.</aside>
    <details><summary>Подготовленный текст</summary><p>{ $draft }</p></details>
order-handoff-html =
    <b>✅ Заявка #{ $id } принята в работу</b>

    Менеджер готов продолжить обмен и согласовать детали.

    <b>Что нужно сделать</b>
    1. Нажмите «Написать менеджеру».
    2. Проверьте подготовленный текст и нажмите кнопку отправки.

    <blockquote><b>Важно.</b> Текст появится в поле ввода, но не отправится автоматически.</blockquote>

    <b>Подготовленный текст:</b>
    { $draft }
order-reminder-rich =
    <h2>🔔 Менеджер ожидает ваше сообщение по заявке #{ $id }</h2>
    <p>Нажмите «Написать менеджеру», проверьте подготовленный текст и отправьте его.</p>
    <aside><b>Важно.</b> Текст не отправляется автоматически.</aside>
order-reminder-html =
    <b>🔔 Менеджер ожидает ваше сообщение по заявке #{ $id }</b>

    Нажмите «Написать менеджеру», проверьте подготовленный текст и отправьте его.

    <blockquote><b>Важно.</b> Текст не отправляется автоматически.</blockquote>
order-completed =
    ✅ Заявка #{ $id } завершена.
