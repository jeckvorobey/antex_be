...
order-handoff-rich =
    ...
    <blockquote>💬 «Напишите менеджеру первым, чтобы открыть диалог. После этого он сможет ответить и согласовать детали обмена.»</blockquote>
    <aside>⚠️ Важно. Текст появится в поле ввода, но не отправится автоматически.</aside>
    <details><summary>📝 Подготовленный текст</summary><p>Напишите менеджеру первым, чтобы открыть диалог. После этого он сможет ответить и согласовать детали обмена.</p></details>
order-handoff-html =
    ...
    💬 «Напишите менеджеру первым, чтобы открыть диалог. После этого он сможет ответить и согласовать детали обмена.»

    ⚠️ Важно. Текст появится в поле ввода, но не отправится автоматически.
order-reminder-rich =
