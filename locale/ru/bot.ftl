...
exchange-start-welcome =
    ...
    Заявки принимаются круглосуточно. Менеджеры работают ежедневно с 09:00 до 21:00 МСК.
...
order-created =
    ✅ Заявка №{ $id } создана.
order-created-offline = Заявка принята. Менеджер обработает её после начала рабочего дня в порядке очереди.
